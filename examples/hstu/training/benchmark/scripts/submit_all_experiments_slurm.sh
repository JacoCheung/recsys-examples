...
for i in "${!EXP_NAMES[@]}"; do
    ...
    EXPORT_VARS="ALL,EXP_NAME=${exp},GIN_OPTIONS=${gin_opts},EXP_OUTPUT_DIR=${EXP_OUTPUT_DIR},ENABLE_NSYS=${ENABLE_NSYS},HSTU_ROOT=${HSTU_ROOT},CONTAINER_IMAGE=${CONTAINER_IMAGE},MEM_DEBUG=${MEM_DEBUG},CUDA_MEM_WATCHDOG=${CUDA_MEM_WATCHDOG},CUDA_MEM_WATCHDOG_THRESHOLD=${CUDA_MEM_WATCHDOG_THRESHOLD:-0.5},CACHE_DEBUG=${CACHE_DEBUG},RECSYS_PIPELINE_BACKEND=${RECSYS_PIPELINE_BACKEND:-legacy},HSTU_THREAD_MAP_VARIANT=${HSTU_THREAD_MAP_VARIANT:-},HSTU_LA_DEPTH=${HSTU_LA_DEPTH:-},HSTU_AUTOSCHED_COST_FILE=${HSTU_AUTOSCHED_COST_FILE:-},HSTU_AUTOSCHED_MAX_IN_FLIGHT=${HSTU_AUTOSCHED_MAX_IN_FLIGHT:-5}"
